...
ORIGINAL_FILES=$2 #"/home/dhamelin/projects/ctb-hussinju/shared/covid-19/GISAID/2023_10_24/PeptideExtracted/"

WORKING_DIRCT=$3 #"/home/dhamelin/projects/ctb-hussinju/shared/covid-19/Kovalchik_paper/Peptide_Temporal_analysis/MHCVal_4_Lineages/" #Create working directory 
...
Output_directory=$5 #"/home/dhamelin/projects/ctb-hussinju/shared/covid-19/Kovalchik_paper/Peptide_Temporal_analysis/MHCVal_4_Lineages/Lineage_summaries_4_TEST/" #subdirectory of working directory where result files are sted
...
for FOLDER in *; do #Iterate through folders (for each peptides)
    ...
    python3 ../PEPTIDE_LINEAGES_CLEANED_UP.py FILES.txt $WORKING_DIRCT$Output_directory$FOLDER $FOLDER #Right_Format_Events_binding_affinity_immunity_Combine_All_Alternative_peptides.py
